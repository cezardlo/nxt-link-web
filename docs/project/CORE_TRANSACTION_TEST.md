...
| 3 | BUYER opens their dashboard | Sees their request(s) + status | **FAIL — no buyer dashboard exists (first failure)** |
...
1. **Step 3:** buyer dashboard (`/buyer` — list my requests + statuses).

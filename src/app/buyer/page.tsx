...
const T: Record<Lang, Record<string, string>> = {
  en: {
    ...
    cmpLaborRate: 'Hourly labor rate', cmpAdditionalFees: 'Additional fees',
    cmpPartsPolicy: 'Parts policy', cmpPartsOemOnly: 'OEM parts only', cmpPartsOemAftermarket: 'OEM or aftermarket',
    cmpPartsCustomerSupplied: 'Customer supplies parts', cmpPartsIncludedInRate: 'Parts included in rate',
    cmpResponseSla: 'Response time on site', cmpRtSameDay: 'Same day', cmpRtWithin24h: 'Within 24 hours',
    cmpRtWithin48h: 'Within 48 hours', cmpRtDays3Plus: '3+ days',
    cmpContractTerms: 'Contract terms',
  ...
  es: {
    ...
    cmpLaborRate: 'Tarifa por hora', cmpAdditionalFees: 'Cargos adicionales',
    cmpPartsPolicy: 'Política de refacciones', cmpPartsOemOnly: 'Solo refacciones OEM', cmpPartsOemAftermarket: 'OEM o aftermarket',
    cmpPartsCustomerSupplied: 'El cliente surte las refacciones', cmpPartsIncludedInRate: 'Refacciones incluidas en la tarifa',
    cmpResponseSla: 'Tiempo de respuesta en sitio', cmpRtSameDay: 'El mismo día', cmpRtWithin24h: 'En menos de 24 horas',
    cmpRtWithin48h: 'En menos de 48 horas', cmpRtDays3Plus: '3 días o más',
    cmpContractTerms: 'Términos de contrato',
...
export default function BuyerDashboardPage() {
  ...
  const cmpLabels: DeckLabels = {
    ...
    extras: {
      ...
      laborRate: t.cmpLaborRate, additionalFees: t.cmpAdditionalFees,
      partsPolicy: t.cmpPartsPolicy, partsOemOnly: t.cmpPartsOemOnly, partsOemAftermarket: t.cmpPartsOemAftermarket,
      partsCustomerSupplied: t.cmpPartsCustomerSupplied, partsIncludedInRate: t.cmpPartsIncludedInRate,
      responseSla: t.cmpResponseSla, rtSameDay: t.cmpRtSameDay, rtWithin24h: t.cmpRtWithin24h,
      rtWithin48h: t.cmpRtWithin48h, rtDays3Plus: t.cmpRtDays3Plus,
      contractTerms: t.cmpContractTerms,

...
const SECTOR_COLORS: Record<string, string> = {
  ...
  'Analytics': '#0284c7', 'Warehouse Automation': '#7c3aed',
  'Trucking Technology': '#059669', 'Trucking OEM': '#047857',
  'Trucking Services': '#0d9488', 'Trucking Carrier': '#0f766e',
  'Defense IT': '#b91c1c', 'Border Tech': '#d97706',
  'Health Tech': '#db2777', 'Route Optimization': '#2563eb',
};
...
export default function VendorsPage() {
  ...
  const fetchVendors = useCallback(label: 'Avg Quality', value: avgScore },

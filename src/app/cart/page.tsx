...
.qc{min-height:100vh;background:#0A0A0F;color:#F0F0F5;font-family:'Outfit',system-ui,sans-serif;-webkit-font-smoothing:antialiased;}
.qc *{box-sizing:border-box;}
.qc-nav{display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;row-gap:8px;gap:12px;padding:14px 26px;border-bottom:1px solid rgba(255,255,255,.08);position:sticky;top:0;background:rgba(10,10,15,.9);backdrop-filter:blur(20px);z-index:30;}
.qc-brand{display:flex;align-items:baseline;gap:10px;color:#F0F0F5;text-decoration:none;}
.qc-brand b{font-size:17px;}.qc-brand i{color:#A78BFA;font-style:normal;}
.qc-brand span{color:#8080A0;font-size:13px;}
.qc-navr{display:flex;align-items:center;gap:12px;flex-wrap:wrap;}
.qc-back{color:#A78BFA;font-size:13.5px;font-weight:600;text-decoration:none;white-space:nowrap;}
.qc-back:hover{color:#C4B5FD;}
.qc-wrap{max-width:720px;margin:0 auto;padding:36px 20px 120px;}
.qc-wrap h1{font-size:28px;font-weight:800;letter-spacing:-.02em;}
.qc-count{font-size:12px;font-weight:700;color:#C4B5FD;background:rgba(124,92,252,.15);border-radius:99px;padding:4px 12px;vertical-align:6px;margin-left:8px;white-space:nowrap;}
.qc-sub{color:#8080A0;font-size:14px;margin:6px 0 24px;line-height:1.6;}
.qc-empty{text-align:center;color:#8080A0;padding:60px 0;}
.qc-empty.big{background:#12121B;border:1px solid rgba(255,255,255,.08);border-radius:18px;padding:48px 24px;}
.qc-empty b{display:block;font-size:18px;color:#F0F0F5;margin-bottom:8px;}
.qc-empty p{font-size:14px;line-height:1.6;max-width:420px;margin:0 auto 18px;}
.qc-multinote{font-size:13px;color:#C4B5FD;background:rgba(124,92,252,.08);border:1px solid rgba(124,92,252,.25);border-radius:10px;padding:10px 14px;line-height:1.55;margin:0 0 18px;}
.qc-group{margin-bottom:22px;}
.qc-group h2{font-size:15px;font-weight:600;color:#C0C0D0;margin:0 0 10px;}
.qc-group h2 b{color:#F0F0F5;}
.qc-group h2 small{color:#8080A0;font-weight:400;font-size:12.5px;margin-left:8px;}
.qc-item{background:#14141F;border:1px solid rgba(255,255,255,.08);border-radius:14px;padding:14px 16px;margin-bottom:10px;}
...
.qc-kind.product{background:rgba(124,92,252,.15);color:#C4B5FD;}
.qc-kind.service{background:rgba(52,211,153,.12);color:#34D399;}
.qc-name{flex:1;min-width:160px;font-size:14.5px;font-weight:700;color:#F0F0F5;text-decoration:none;line-height:1.35;}
.qc-name:hover{color:#C4B5FD;}
.qc-remove{font-family:inherit;font-size:12px;font-weight:600;background:none;border:1px solid rgba(255,255,255,.12);color:#8080A0;border-radius:8px;padding:6px 11px;cursor:pointer;}
.qc-remove:hover{border-color:rgba(252,165,165,.5);color:#FCA5A5;}
...
.qc-qtylabel{font-size:12px;color:#8080A0;}
.qc-qty button{width:32px;height:32px;font-size:17px;font-family:inherit;font-weight:700;border-radius:9px;border:1px solid rgba(255,255,255,.14);background:none;color:#C0C0D0;cursor:pointer;line-height:1;}
.qc-qty button:hover:not(:disabled){border-color:#7C5CFC;color:#C4B5FD;}
...
.qc-note{flex:1;min-width:200px;font-family:inherit;font-size:13.5px;padding:9px 12px;border-radius:9px;border:1px solid rgba(255,255,255,.1);background:#0A0A0F;color:#F0F0F5;outline:none;}
.qc-note:focus{border-color:#7C5CFC;}
.qc-clear{font-family:inherit;font-size:12.5px;font-weight:600;background:none;border:none;color:#63607A;cursor:pointer;text-decoration:underline;padding:0;margin:2px 0 8px;}
.qc-clear:hover{color:#9A97AF;}
.qc-form{background:#12121B;border:1px solid rgba(255,255,255,.08);border-radius:16px;padding:20px;margin-top:18px;display:flex;flex-direction:column;gap:12px;position:relative;}
.qc-form h2{font-size:16px;font-weight:800;margin:0;}
...
.qc-form label{display:flex;flex-direction:column;gap:6px;font-size:12px;color:#8080A0;font-weight:600;}
.qc-form input,.qc-form textarea{font-family:inherit;font-size:14px;padding:11px 13px;border-radius:10px;border:1px solid rgba(255,255,255,.1);background:#0A0A0F;color:#F0F0F5;outline:none;resize:vertical;}
.qc-form input:focus,.qc-form textarea:focus{border-color:#7C5CFC;}
.qc-err{color:#FCA5A5;font-size:13px;}
.qc-primary{display:inline-block;font-family:inherit;font-size:14.5px;font-weight:700;padding:13px 22px;border-radius:11px;border:none;background:#7C5CFC;color:#fff;cursor:pointer;text-decoration:none;text-align:center;}
.qc-primary:hover{background:#6344DF;}
.qc-primary:disabled{opacity:.6;cursor:not-allowed;}
.qc-secondary{display:inline-block;font-family:inherit;font-size:13.5px;font-weight:600;padding:12px 18px;border-radius:11px;border:1px solid rgba(255,255,255,.14);background:none;color:#C0C0D0;text-decoration:none;text-align:center;}
.qc-secondary:hover{border-color:rgba(124,92,252,.5);color:#C4B5FD;}
.qc-submit{width:100%;}
.qc-safenote{margin:0;font-size:12.5px;font-weight:600;color:#34D399;text-align:center;}
.qc-disclosure{margin:0;font-size:11.5px;line-height:1.5;color:#7A7A92;}
.qc-disclosure a{color:#9A97AF;}
.qc-sent{background:rgba(52,211,153,.06);border:1px solid rgba(52,211,153,.3);border-radius:18px;padding:26px 24px;}
.qc-sent>b{font-size:19px;color:#6EE7B7;}
.qc-sent ul{list-style:none;margin:16px 0;padding:0;display:flex;flex-direction:column;gap:10px;}
.qc-sent li{display:flex;flex-direction:column;gap:3px;background:#12121B;border:1px solid rgba(255,255,255,.08);border-radius:12px;padding:12px 15px;font-size:13.5px;color:#C0C0D0;}
.qc-sent li b{color:#F0F0F5;}
.qc-sentvendor{font-weight:700;color:#F0F0F5;font-size:14.5px;}
.qc-skipnote{color:#FBBF24;font-size:13px;line-height:1.5;}
.qc-sent p{color:#C0C0D0;font-size:14px;line-height:1.6;}

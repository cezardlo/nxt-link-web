...
const STR: Record<Lang, Record<string, string>> = {
  en: {
    ...
    deleteBody: 'This permanently deletes your profile, listings, saved items, and cart. Records we must keep for legal and accounting reasons (past deals, invoices, and agreed terms) are kept but stripped of your name and contact details. This cannot be undone.',
  ...
  es: {
    ...
    deleteBody: 'Esto elimina permanentemente tu perfil, tus anuncios, tus elementos guardados y tu carrito. Los registros que debemos conservar por motivos legales y contables (tratos anteriores, facturas y términos acordados) se conservan, pero se les quita tu nombre y datos de contacto. Esta acción no se puede deshacer.',

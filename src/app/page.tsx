...
const T: Record<Lang, Record<string, string>> = {
  en: {
    ...
    faq2a: 'Yes. Creating an account, browsing, comparing, and requesting quotes is free for buyers. Vendors join free too — NXT//LINK only earns a success fee after a deal closes (5% on the first $50k, 3% above, capped at $20,000).',
  ...
  es: {
    ...
    faq2a: 'Sí. Crear una cuenta, explorar, comparar y solicitar cotizaciones es gratis para compradores. Los proveedores también se unen gratis — NXT//LINK solo gana una comisión de éxito cuando se cierra un trato (5% sobre los primeros $50,000 USD, 3% sobre el resto, con tope de $20,000).',
